...
void infrared_scene_universal_tv2_on_enter(void* context) {
    infrared_scene_universal_common_on_enter(context);  // same for all universal remotes
...
bool infrared_scene_universal_tv2_on_event(void* context, SceneManagerEvent event) {
    return infrared_scene_universal_common_on_event(context, event);
}

void infrared_scene_universal_tv2_on_exit(void* context) {
